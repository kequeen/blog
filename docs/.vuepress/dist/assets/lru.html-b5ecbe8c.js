import{_ as n,o as s,c as a,e as t}from"./app-d43038e2.js";const p={},e=t(`<h1 id="lru" tabindex="-1"><a class="header-anchor" href="#lru" aria-hidden="true">#</a> LRU</h1><p>LRU算法也算是最经典的面试算法之一了,其实本身就是一个双向链表。 链表本身分为单向链表、双向链表、循环链表，之前是把双向链表 + 循环链表 搞混了，这两个本质上还是不一样的</p><h2 id="经典lru" tabindex="-1"><a class="header-anchor" href="#经典lru" aria-hidden="true">#</a> 经典lru</h2><p>其实核心还是一个双向链表 + map 核心就是一个双向链表的节点 + 一个map快速判断是否存在 还有一些删除和新增的操作</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token comment">// 定义一个双向链表的结构</span>
