import{_ as e,r as p,o,c as i,a as n,b as a,d as t,e as l}from"./app-9a10e8bd.js";const c={},r=l(`<h1 id="贪心算法" tabindex="-1"><a class="header-anchor" href="#贪心算法" aria-hidden="true">#</a> 贪心算法</h1><p>贪心算法与动态规划算法的不同在于，他对每个子问题的解决方案都做出选择，不能回退。<br> 动态规划会保存以前的计算结果，有回退功能.<br> 贪心的话，一般会在时间复杂度上更优于标准的动态规划，因为其不做回溯。<br> 我们也可以理解，贪心其实是动态规划的特殊情况。</p><h2 id="标准流程" tabindex="-1"><a class="header-anchor" href="#标准流程" aria-hidden="true">#</a> 标准流程</h2><ol><li>创建数学模型来描述问题。</li><li>把求解的问题分成若干个子问题。</li><li>对每一子问题求解，得到子问题的局部最优解。</li><li>把子问题的解局部最优解合成原来解问题的一个解。</li></ol><h2 id="常见算法" tabindex="-1"><a class="header-anchor" href="#常见算法" aria-hidden="true">#</a> 常见算法</h2><h3 id="乘最多水的容器" tabindex="-1"><a class="header-anchor" href="#乘最多水的容器" aria-hidden="true">#</a> 乘最多水的容器</h3><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token comment">//https://leetcode.cn/problems/container-with-most-water/description/</span>
